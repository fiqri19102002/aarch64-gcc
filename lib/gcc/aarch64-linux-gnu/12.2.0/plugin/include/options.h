...
enum opt_code
{
  ...
  OPT_mcmodel_ = 1778,                       /* -mcmodel= */
  OPT_mcpu_ = 1779,                          /* -mcpu= */
  OPT_mfix_cortex_a53_835769 = 1780,         /* -mfix-cortex-a53-835769 */
  OPT_mfix_cortex_a53_843419 = 1781,         /* -mfix-cortex-a53-843419 */
  OPT_mgeneral_regs_only = 1782,             /* -mgeneral-regs-only */
  OPT_mglibc = 1783,                         /* -mglibc */
  OPT_mharden_sls_ = 1784,                   /* -mharden-sls= */
  OPT_mlittle_endian = 1785,                 /* -mlittle-endian */
  OPT_mlow_precision_div = 1786,             /* -mlow-precision-div */
  OPT_mlow_precision_recip_sqrt = 1787,      /* -mlow-precision-recip-sqrt */
  OPT_mlow_precision_sqrt = 1788,            /* -mlow-precision-sqrt */
  OPT_mmusl = 1789,                          /* -mmusl */
  ...
  OPT_profile = 1841,                        /* -profile */
  OPT_pthread = 1842,                        /* -pthread */
  OPT_quiet = 1843,                          /* -quiet */
  OPT_r = 1844,                              /* -r */
  OPT_rdynamic = 1845,                       /* -rdynamic */
